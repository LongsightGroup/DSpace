...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
                  ...
                  <xsl:otherwise>
                    <div id="masthead">
                      <div class="container clearfix">
                        ...
                        <p class="progress"><a href="http://saylor.org/">Saylor.org</a> / <a href="http://eportfolio.saylor.org/">ePortfolio</a> / <a href="http://library.saylor.org/">Library</a></p>
                      </div>
                    </div>
                    <div id="ds-main">
   ...
   <xsl:if test="$ccLicenseName and $ccLicenseUri and contains($ccLicenseUri, 'creativecommons')">
    ...
    <div id="footer_new">
      <div class="container_forums clearfix_forums">
        <div class="left_forums">
          <h2 class="footer_logo_forums"><a href="http://www.saylor.org/">saylor.org</a></h2>
        </div>

        <ul id="footernav">
          <li><a href="http://www.saylor.org/">Saylor.org</a></li>
          <li><a href="http://www.saylor.org/about/">About Us</a></li>
          <li><a href="http://www.saylor.org/saylor-foundation-status/">Our Progress</a></li>
          <li><a href="http://www.saylor.org/media-center/">Media Center</a></li>
          <li><a href="http://www.saylor.org/donate/">Donate</a></li>
          <li><a href="http://www.saylor.org/feedback/">Contact Us</a></li>
        </ul>
      ...
      <div class="container_forums clearfix_forums">
        ...
        <div class="right_forums">
          <p>Except where otherwise noted, content on this site is licensed<br/>under a Creative Commons Attribution 3.0 Unported License.<br/>&#169; 2012 The Saylor Foundation | <a href="http://saylor.org/sitemap/">Sitemap</a> | <a href="/privacy-policy/">Privacy Policy</a> | <a href="http://www.saylor.org/terms-of-use/">Terms of Use</a><br/>Saylor.org&#153;, The Saylor Journals&#153;, Harnessing Technology to Make Education Free&#153;</p>
          <p class="cc_forums"><a target="_blank" href="http://creativecommons.org/licenses/by/3.0/">Creative Commons</a></p>
          <p class="ocw_forums"><a target="_blank" href="http://www.ocwconsortium.org/">OCW Consortium</a></p>
        </div>
      </div>
    </div>
