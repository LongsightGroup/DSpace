...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM-fields">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 4 and (dim:field[@element='publisher'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 5 and (dim:field[@element='source'])">
                    <div class="simple-item-view-other">
          ...
          <xsl:when test="$clause = 6 and (dim:field[@element='subject'])">
                    <div class="simple-item-view-other">
	                ...
	                <span>
		                <xsl:for-each select="dim:field[@element='subject']">
		                	<xsl:copy-of select="./node()"/>
		                	<xsl:if test="count(following-sibling::dim:field[@element='subject']) != 0"><xsl:text>; </xsl:text></xsl:if>
		                </xsl:for-each>
	                </span>
	            </div>
              <xsl:call-template name="itemSummaryView-DIM-fields">
