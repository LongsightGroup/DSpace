                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="{$context-path}/" class="navbar-brand">
                            <img src="{$theme-path}/images/liblogo.png" />
                        </a>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-10">
                        <div class="row">
                            <a href="http://www.fandm.edu/">©2016 Franklin &amp; Marshall College | 450 College Ave | PO Box 3003 | Lancaster, PA 17604 </a>&#160;&#160;
                            <a href="https://www.facebook.com/fandmlibrary" target="_blank"><img src="{$theme-path}/images/fb_lblue.png" width="25" alt="Facebook" class="icon"/></a>&#160;&#160;
                            <a href="http://twitter.com/fandmlibrary"><img src="{$theme-path}/images/twi_lblue.png" width="25" alt="Twitter" class="icon"/></a>&#160;&#160;
                            <a href="http://pinterest.com/fandmlibrary/boards/"><img src="{$theme-path}/images/pin_lblue.png" width="25" alt="Pinterest" class="icon"/></a>&#160;&#160;
                            <a href="http://instagram.com/fandmlibrary"><img src="{$theme-path}/images/ig_lblue 2.png" width="25" alt="Instagram" class="icon"/></a>&#160;&#160;
                            <a href="http://www.fandm.edu"><img src="{$theme-path}/images/fandmft1.gif" width="25" alt="Fandm" class="icon"/></a>
                        </div>
