        ...
        <div id="ds-options" class="word-break">
            <div class="ds-option-set">
                <ul class="list-group">
                    ...
                    <li class="list-group-item ds-option"><a target="_blank" href="http://archon.kennesaw.edu ">All Collections</a></li>
                </ul>
            </div>
            ...
            <div class="ds-option-set">
                <ul class="list-group">
                    <li class="list-group-item ds-option"><a target="_blank" href="http://archives.kennesaw.edu/soar_policies.php">Policies</a></li>
