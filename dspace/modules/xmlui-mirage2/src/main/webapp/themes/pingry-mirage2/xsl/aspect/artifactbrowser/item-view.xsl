...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM-subject-teamMember">
        <xsl:if test="dim:field[@element='subject'][@qualifier='teamMember' and descendant::text()]">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>Team Member</h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='subject'][@qualifier='teamMember']">
                        <xsl:for-each select="dim:field[@element='subject'][@qualifier='teamMember']">
                            <xsl:call-template name="itemSummaryView-DIM-authors-entry" />
                        </xsl:for-each>
                    </xsl:when>
                </xsl:choose>
    ...
    <xsl:template name="itemSummaryView-DIM-subject-notPictured">
        <xsl:if test="dim:field[@element='subject'][@qualifier='notPictured' and descendant::text()]">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>Not Pictured</h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='subject'][@qualifier='notPictured']">
                        <xsl:for-each select="dim:field[@element='subject'][@qualifier='notPictured']">
                            <xsl:call-template name="itemSummaryView-DIM-authors-entry" />
                        </xsl:for-each>
                    </xsl:when>
                </xsl:choose>
    ...
    <xsl:template name="itemSummaryView-DIM-subject-coach">
        <xsl:if test="dim:field[@element='subject'][@qualifier='coach' and descendant::text()]">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>Coach</h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='subject'][@qualifier='coach']">
                        <xsl:for-each select="dim:field[@element='subject'][@qualifier='coach']">
                            <xsl:call-template name="itemSummaryView-DIM-authors-entry" />
                        </xsl:for-each>
                    </xsl:when>
                </xsl:choose>
    ...
    <xsl:template name="itemSummaryView-DIM-subject-captain">
        <xsl:if test="dim:field[@element='subject'][@qualifier='captain' and descendant::text()]">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>Team Member</h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='subject'][@qualifier='captain']">
                        <xsl:for-each select="dim:field[@element='subject'][@qualifier='captain']">
                            <xsl:call-template name="itemSummaryView-DIM-authors-entry" />
                        </xsl:for-each>
                    </xsl:when>
                </xsl:choose>
    ...
    <xsl:template name="itemSummaryView-DIM-subject-manager">
        <xsl:if test="dim:field[@element='subject'][@qualifier='manager' and descendant::text()]">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>Team Member</h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='subject'][@qualifier='manager']">
                        <xsl:for-each select="dim:field[@element='subject'][@qualifier='manager']">
                            <xsl:call-template name="itemSummaryView-DIM-authors-entry" />
                        </xsl:for-each>
                    </xsl:when>
                </xsl:choose>
    ...
    <xsl:template name="itemSummaryView-DIM-subject-assistantManager">
        <xsl:if test="dim:field[@element='subject'][@qualifier='assistantManager' and descendant::text()]">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h5>Assistant Manager</h5>
                <xsl:choose>
                    <xsl:when test="dim:field[@element='subject'][@qualifier='assistantManager']">
                        <xsl:for-each select="dim:field[@element='subject'][@qualifier='assistantManager']">
                            <xsl:call-template name="itemSummaryView-DIM-authors-entry" />
                        </xsl:for-each>
                    </xsl:when>
                </xsl:choose>
            ...
            <xsl:when test="//mets:fileSec/mets:fileGrp[@USE='CONTENT' or @USE='ORIGINAL' or @USE='LICENSE']/mets:file">
                <div class="item-page-field-wrapper table word-break">
                    ...
                    <xsl:for-each select="//mets:fileSec/mets:fileGrp[@USE='CONTENT' or @USE='ORIGINAL' or @USE='LICENSE']/mets:file">
                        <xsl:if test="contains(mets:FLocat[@LOCTYPE='URL']/@xlink:label, 'presentation') or not(mets:FLocat[@LOCTYPE='URL']/@xlink:label)">
                    ...
                    <tr>
                        ...
                        <td class="metadata-field word-break">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="$element='subject' and ($qualifier='teamMember' or
                                                                        $qualifier='notPictured' or
                                                                        $qualifier='coach' or
                                    ...
                                    <xsl:for-each select="dim:field[@mdschema=$schema and @element=$element and @qualifier=$qualifier and descendant::text()]">
                                        <a>
                                            ...
                                            <xsl:attribute name="title">
                                                <xsl:value-of select="./node()"/>
                                                <xsl:if test="@authority">
                                                    <xsl:text> - with PingryID: </xsl:text>
