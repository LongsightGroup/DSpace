...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM">
        ...
        <!--<script type="text/javascript" src="{concat($theme-path, 'geoLinkComponent/js/geoLink.js')}">&#160;</script>-->
        <!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js" crossorigin="anonymous">&#160;</script>-->
        <script src="{concat($theme-path, 'geoLinkComponent/geocomponent/components/glperson-element/bower_components/webcomponentsjs/webcomponents-lite.js')}">&#160;</script>
        <!--<link rel="import" href="{concat($theme-path, 'geoLinkComponent/glCruiseSearch.html')}">&#160;</link>-->
        ...
        <div class="item-summary-view-metadata">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <xsl:call-template name="itemSummaryView-DIM-dc.relation.uri"/>
                    <xsl:call-template name="itemSummaryView-DIM-dc.date.created"/>
                    <xsl:call-template name="itemSummaryView-DIM-dc.coverage.spatial"/>
                    <xsl:call-template name="itemSummaryView-DIM-relatedMaterial"/>
                    <xsl:call-template name="itemSummaryView-DIM-dc.identifier.doi"/>
                    ...
                    <xsl:call-template name="itemSummaryView-DIM-dc.embargo.liftdate"/>
    ...
    <xsl:template name="itemSummaryView-DIM-dc.relation.uri">
    ...
    <xsl:template name="itemSummaryView-DIM-dc.date.created">
        <xsl:if test="dim:field[@element='date' and @qualifier='created' and descendant::text()]">
            <div class="simple-item-view-uri item-page-field-wrapper table">
                <h5><i18n:text>xmlui.metadata.dc.date.created</i18n:text></h5>
                <span>
    ...
    <xsl:template name="itemSummaryView-DIM-dc.coverage.spatial">
        <xsl:if test="dim:field[@element='coverage' and @qualifier='spatial' and descendant::text()]">
            <div class="simple-item-view-uri item-page-field-wrapper table">
                <h5><i18n:text>xmlui.metadata.dc.coverage.spatial</i18n:text></h5>
                <span>
    ...
    <xsl:template name="itemSummaryView-DIM-relatedMaterial">
        <xsl:if test="dim:field[@element='relation'][@qualifier='ispartof' and descendant::text()] or
                      dim:field[@element='relation'][@qualifier='haspart' and descendant::text()] or
                      dim:field[@element='relation'][@qualifier='requires' and descendant::text()] ">
            <div class="simple-item-view-authors item-page-field-wrapper table">
    ...
    <xsl:template name="itemSummaryView-DIM-dc.identifier.doi">
        <xsl:if test="dim:field[@element='identifier' and @qualifier='doi' and descendant::text()]">
            <div class="simple-item-view-uri item-page-field-wrapper table">
                <h5><i18n:text>xmlui.metadata.dc.identifier.doi</i18n:text></h5>
                <span>
    ...
    <xsl:template name="itemSummaryView-DIM-dc.embargo.liftdate">
        <xsl:if test="dim:field[@element='embargo' and @qualifier='liftdate' and descendant::text()]">
            <div class="simple-item-view-uri item-page-field-wrapper table">
                <h5>Publisher Embargo:</h5>
